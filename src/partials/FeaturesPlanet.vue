    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-16 md:pb-20">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-200">Simple helps your teams work more efficiently
            together</h2>
        </div>
        ...
        <div class="pb-16 md:pb-20" data-aos="zoom-y-out">
          <div class="text-center">
            <div
              class="inline-flex relative rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.blue.500),transparent)]">
              <img class="bg-gray-900 rounded-full" src="../images/planet.png" width="400" height="400" alt="Planet" />
        ...
        <div
          ...
          <article>
            ...
            <p class="text-[15px] text-gray-400">Collect essential insights about how visitors are using your site with
