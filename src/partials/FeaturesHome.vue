    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-24 md:pb-28">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Identify value much faster</h2>
          <p class="text-lg text-gray-700">Use powerful yet familiar tools to create your ultimate website design.
            Import your files everywhere, including Figma.</p>
        </div>
        ...
        <div class="group relative w-full max-w-[500px] mx-auto flex justify-center mb-32 md:mb-36"
          ...
          <div class="absolute bottom-0 -z-10" aria-hidden="true">
            <div class="w-80 h-80 rounded-full bg-blue-500 opacity-70 blur-[160px]"></div>
          </div>
          <div
            ...
            <div
              class="relative flex items-center justify-between before:block before:w-[41px] before:h-[9px] before:[background-image:radial-gradient(circle_at_4.5px_4.5px,_theme(colors.gray.600)_4.5px,_transparent_0)] before:bg-[length:16px_9px] after:w-[41px] mb-8">
              <span class="text-white font-medium text-[13px]">AI Project</span>
            </div>
            <div
              class="text-gray-500 font-mono [&_span]:opacity-0 text-sm blur-sm group-hover:blur-none transition duration-300">
          ...
          <div class="absolute top-16">
            <div
              ...
              <img class="-rotate-2" src="../images/features-02-overlay-01.png" width="500" height="72" alt="Overlay 01">
            </div>
            <div
            ...
            <div
              ...
              <img class="-rotate-1" src="../images/features-02-overlay-03.png" width="500" height="91" alt="Overlay 03">
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <article>
            ...
            <p class="text-[15px] text-gray-700">Collect essential insights about how visitors are using your site with
              in-depth page view metrics like pages, referring sites, and more.</p>
          </article>
          <article>
            <h3 class="font-medium flex items-center space-x-2 mb-2">
