...
const testimonials = [
  ...
  },
  {
    ...
    date: 'Dec 02, 2026',
    content: 'I\'ve been using Simple for over a year now, and it has transformed the way I work. It\'s intuitive, efficient, and has all the features I need to stay productive.',
    channel: 'Twitter'
  },
  {
    ...
    date: 'Nov 11, 2026',
    content: 'Simple has made a significant impact on my business. It has helped me streamline my workflow, improve my productivity, and grow my brand. I highly recommend it to anyone looking to do the same.',
    channel: 'Twitter'
  },
  {
    ...
    username: '@lovingme_',
    date: 'Oct 23, 2026',
    content: 'I\'ve been using Simple for a few months now, and I can\'t imagine my life without it. It has simplified my work process, increased my efficiency, and helped me achieve my goals faster.',
    channel: 'Twitter'
  },
  {
    ...
    username: '@kavigirl99',
    date: 'Sep 30, 2026',
    content: 'Simple has been a game-changer for me. It has helped me stay organized, manage my tasks more efficiently, and improve my overall productivity. I can\'t recommend it enough!',
    channel: 'Twitter'
  },
  {
    ...
    username: '@dante1987',
    date: 'Aug 17, 2026',
    content: 'I\'ve been using Simple for a while now, and it has transformed the way I work. It\'s intuitive, efficient, and has all the features I need to stay productive.',
    channel: 'Twitter'
  },
]
</script>
...
<template>
  <section
    ...
    <div class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 -z-10" aria-hidden="true">
      <div class="w-80 h-80 rounded-full bg-gradient-to-tr from-blue-500 to-gray-900 opacity-30 blur-[160px]">
      </div>
    </div>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        <div class="max-w-3xl mx-auto text-center mb-8">
          <h2 class="text-3xl md:text-4xl font-bold">Top brands grow with Simple</h2>
        </div>
        <!-- Logos -->
        <div class="pb-12 md:pb-16">
          <div class="flex flex-wrap items-center justify-center text-gray-600">
            <div
              class="relative px-6 lg:px-12 py-4 before:absolute before:left-0 before:top-1/2 before:w-px before:h-3 before:-translate-y-1/2 before:bg-gray-300 first:before:hidden max-lg:before:hidden">
              <svg xmlns="http://www.w3.org/2000/svg" width="100" height="19" fill="none">
                <title>Facebook</title>
                <path class="fill-current" fill-opacity=".72" fill-rule="evenodd"
            ...
            <div
              class="relative px-6 lg:px-12 py-4 before:absolute before:left-0 before:top-1/2 before:w-px before:h-3 before:-translate-y-1/2 before:bg-gray-300 first:before:w-0 first:before:hidden max-lg:before:hidden">
            ...
            <div
              class="relative px-6 lg:px-12 py-4 before:absolute before:left-0 before:top-1/2 before:w-px before:h-3 before:-translate-y-1/2 before:bg-gray-300 first:before:w-0 first:before:hidden max-lg:before:hidden">
              <svg xmlns="http://www.w3.org/2000/svg" width="76" height="34" fill="none">
                <title>Quora</title>
                <path class="fill-current" fill-opacity=".72" fill-rule="evenodd"
        ...
        <!-- Testimonials grid -->
        <div class="grid sm:grid-cols-3 gap-4 md:gap-6 [mask-image:_linear-gradient(to_top,theme(colors.white/.3),_black_800px)]">
          <Testimonial v-for="(testimonial, index) in testimonials" :key="index" :testimonial="testimonial" class="w-full">
            {{ testimonial.content }}
          </Testimonial>           
        </div>
      </div>
