  ...
  <div class="flex flex-col min-h-screen overflow-hidden supports-[overflow:clip]:overflow-clip">
    ...
    <main class="relative grow flex">
      ...
      <div class="absolute left-0 -translate-x-1/3 bottom-0 pointer-events-none" aria-hidden="true">
        <div class="w-80 h-80 rounded-full bg-gradient-to-tr from-blue-500 opacity-70 blur-[160px]"></div>
      </div>
            ...
            <div class="w-full max-w-sm mx-auto">
              <div class="py-16 md:py-20">
                ...
                <form>
                  ...
                  <div class="mt-6">
                    <button
                      class="btn text-white bg-gradient-to-t from-blue-600 to-blue-500 bg-[length:100%_100%] hover:bg-[length:100%_150%] bg-[bottom] shadow w-full">Sign
                      In</button>
                  </div>
                </form>
                ...
                <div class="text-center mt-6">
                  <router-link class="text-sm text-gray-700 underline hover:no-underline" to="/reset-password">Forgot password</router-link>
                </div>
